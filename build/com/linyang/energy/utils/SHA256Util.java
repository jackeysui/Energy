...
public class SHA256Util {
	...
	public static String sha256Encode(String origin, String charsetname) {
		...
		try {
			...
			Log.error("SHA256Util -- md5Encode error!");
		}
		catch (UnsupportedEncodingException e) {
			Log.error("SHA256Encode error UnsupportedEncodingException"+e.getMessage());
		}
		return resultString;
	}
	...
	public static boolean validatePassword(String password, String inputString) {
		...
		if (password != null && password.equals(encodeBySHA256(inputString))) {
			return true;
		} else {
			return false;
		}
	...
	public static String encodeBySHA256(String originString) {
		if (originString != null) {
			try {
				...
				Log.error("shaUtil.encodeBySHA256--sha加密出错");
			}
		}
		return null;
	}
