...
/**
 * Created by Administrator on 19-1-22.
 */
public class HeatingRedirectServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) {
        try {
            request.getRequestDispatcher("/frameController/showLoginPage.htm?loginPath=heat_login").forward(request, response);
